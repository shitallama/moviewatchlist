        ...
        <div class="nav-container">
            ...
            <div class="nav-menu" id="navMenu">
                <ul class="nav-links">
                    ...
                    <li><a href="<?php echo $basePath; ?>genres_management/view_genre.php"><img class="icon" src="<?php echo $basePath; ?>assets/icons/tag.svg" alt="" aria-hidden="true"> Genres</a></li>
                    <li><a href="<?php echo $basePath; ?>review_system/all_reviews.php"><img class="icon" src="<?php echo $basePath; ?>assets/icons/star.svg" alt="" aria-hidden="true"> Reviews</a></li>
                    <?php endif; ?>
                </ul>
